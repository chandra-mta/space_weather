...
set file = https://services.swpc.noaa.gov/text/ace-epam.txt
...
#wget -nv -O $SPACE_Wdir/returned $file
curl --silent -L -o $SPACE_Wdir/returned $file

$SPACE_Wdir/archive_create.py

#$SPACE_Wdir/ace_12h_viol.pl
#above script replaces with ace_viol.py in /data/mta4/Space_Weather/ACE/ace_viol.py
...
#wget -v -O $WEBdir/Epam_7d.gif       http://services.swpc.noaa.gov/images/ace-epam-7-day.gif
#wget -v -O $WEBdir/mta_ace_plot.gif  http://services.swpc.noaa.gov/images/ace-epam-7-day.gif

curl --silent -L -o $WEBdir/Epam_7d.gif http://services.swpc.noaa.gov/images/ace-epam-7-day.gif
curl --silent -L -o $WEBdir/mta_ace_plot.gif http://services.swpc.noaa.gov/images/ace-epam-7-day.gif
...
#wget -nv -O $WEBdir/Mag_swe_7d.gif  http://services.swpc.noaa.gov/images/ace-mag-swepam-7-day.gif
curl --silent -L -o $WEBdir/Mag_swe_7d.gif http://services.swpc.noaa.gov/images/ace-mag-swepam-7-day.gif
