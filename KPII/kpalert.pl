...
#
#   Oct 21, 2015:   minor changes and clean up made      (TI)
...
system("/data/mta4/space_weather/KPII/calculate_kp.csh");
...
sub send_email {
    ...
    @email = qw(brad swolk);
    foreach (@email) {
	    open (MAIL, "| mailx -s 'Kp-ALERT! TEST' $_\n") or die "Cannot send email\n";
	    print MAIL $msg;
	    close MAIL;
    }
}
...
#
    ...
    $DSNsched_file = "/data/mta4/proj/rac/ops/ephem/dsn_summary.dat";
...
#
    ...
    $msg .= sprintf "Value = $af_kp (static limit: $kp)\n";
