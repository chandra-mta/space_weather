...
/opt/local/bin/lynx -source $file >! $SPACE_Wdir/G10returned1
    ...
    tail -24 $SPACE_Wdir/G10returned1 | head -24 >! $SPACE_Wdir/G10returned
...
cat $SPACE_Wdir/G10header $SPACE_Wdir/G10data  $SPACE_Wdir/G12image $SPACE_Wdir/G12image2  $SPACE_Wdir/G10footer >! $WEBdir/G10.html
