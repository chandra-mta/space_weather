...
if ($count > 28) then 
   ...
   #rm $SPACE_Wdir/lasthour
    ...
    nawk -F" " -f $SPACE_Wdir/process_ace_no_alerts.nawk $SPACE_Wdir/last45 > $SPACE_Wdir/xacedata
...
cat $SPACE_Wdir/header $SPACE_Wdir/xacedata  $SPACE_Wdir/image2 $SPACE_Wdir/rob1 $SPACE_Wdir/footer >! $WEBdir/ace.html


cat $SPACE_Wdir/header_i $SPACE_Wdir/xacedata  $SPACE_Wdir/image_i  $SPACE_Wdir/rob1 $SPACE_Wdir/footer >! $WEBdir/ace_i.html
